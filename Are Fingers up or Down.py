     ...
     if hand_count==1:
         ...
         if len(b and a)!=0:
            ...
            for id in range(0,4):
                if a[tip[id]][2:] < a[tip[id]-2][2:]:
                   fingers_count.append(int(b[tipname[id]]))
         ...
         #Below will print to the terminal the number of fingers that are up or down
            ...
            if fingers_count==[0,0,0,0]:
                print("led close")
            if fingers_count==[8,0,0,0]:
                print("L")
            if fingers_count==[8,12,16,20]:
                print("open")
            if fingers_count==[8,0,0,20]:
                print("swag")
            if fingers_count==[8,12,16,0]:
                print("3")
            if fingers_count==[8,12,0,0]:
                print("v")
         ...
         #Below will speak out load when |s| is pressed on the keyboard about what fingers are up or dow
